#ifndef CORE_CORE_RUN_HANDLERS_OPERATOR_HANDLERS_HANDLE_OPERATOR_BXOR_H_
#define CORE_CORE_RUN_HANDLERS_OPERATOR_HANDLERS_HANDLE_OPERATOR_BXOR_H_
...
extern inline SLErrCode runtime_handle_operator_bxor(SLInterpreter *interpreter);

inline SLErrCode runtime_handle_operator_bxor(SLInterpreter *interpreter) {
