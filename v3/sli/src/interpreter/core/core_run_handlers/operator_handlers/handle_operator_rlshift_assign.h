#ifndef CORE_CORE_RUN_HANDLERS_OPERATOR_HANDLERS_HANDLE_OPERATOR_RLSHIFT_ASSIGN_H_
#define CORE_CORE_RUN_HANDLERS_OPERATOR_HANDLERS_HANDLE_OPERATOR_RLSHIFT_ASSIGN_H_
...
extern inline SLErrCode runtime_handle_operator_rlshift_assign(SLInterpreter *interpreter);

inline SLErrCode runtime_handle_operator_rlshift_assign(SLInterpreter *interpreter) {
        ...
        case SL_TOKEN_TYPE_INT_LITERAL:
            op_b_int =
                interpreter
                    ...
                    .data
                    .int_literal;
            *op_a_int_var = (uint64_t)(*op_a_int_var) >> op_b_int;
            break;
        case SL_TOKEN_TYPE_INT_VAR:
            offset =
                interpreter
        ...
        case SL_TOKEN_TYPE_CHAR_LITERAL:
            op_b_char =
                interpreter
                    ...
                    .data
                    .char_literal;
            *op_a_char_var = (uint8_t)(*op_a_char_var) >> op_b_char;
            break;
        case SL_TOKEN_TYPE_CHAR_VAR:
            offset =
                interpreter
