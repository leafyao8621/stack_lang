#ifndef CORE_CORE_RUN_HANDLERS_OPERATOR_HANDLERS_HANDLE_OPERATOR_MULTIPLY_H_
#define CORE_CORE_RUN_HANDLERS_OPERATOR_HANDLERS_HANDLE_OPERATOR_MULTIPLY_H_
...
extern inline SLErrCode runtime_handle_operator_multiply(SLInterpreter *interpreter);

inline SLErrCode runtime_handle_operator_multiply(SLInterpreter *interpreter) {
