#ifndef CORE_CORE_RUN_HANDLERS_OPERATOR_HANDLERS_HANDLE_OPERATOR_LAND_H_
#define CORE_CORE_RUN_HANDLERS_OPERATOR_HANDLERS_HANDLE_OPERATOR_LAND_H_
...
extern inline SLErrCode runtime_handle_operator_land(SLInterpreter *interpreter);

inline SLErrCode runtime_handle_operator_land(SLInterpreter *interpreter) {
