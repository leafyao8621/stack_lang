#ifndef CORE_CORE_RUN_HANDLERS_OPERATOR_HANDLERS_HANDLE_OPERATOR_GEQ_H_
#define CORE_CORE_RUN_HANDLERS_OPERATOR_HANDLERS_HANDLE_OPERATOR_GEQ_H_
...
extern inline SLErrCode runtime_handle_operator_geq(SLInterpreter *interpreter);

inline SLErrCode runtime_handle_operator_geq(SLInterpreter *interpreter) {
