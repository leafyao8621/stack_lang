#ifndef CORE_CORE_RUN_HANDLERS_OPERATOR_HANDLERS_HANDLE_OPERATOR_SUBTRACT_ASSIGN_H_
#define CORE_CORE_RUN_HANDLERS_OPERATOR_HANDLERS_HANDLE_OPERATOR_SUBTRACT_ASSIGN_H_
...
extern inline SLErrCode runtime_handle_operator_subtract_assign(SLInterpreter *interpreter);

inline SLErrCode runtime_handle_operator_subtract_assign(SLInterpreter *interpreter) {
    ...
    Idx offset;
    op_b_int = op_b_float = op_b_char = offset = 0;
    op_a_int_var = NULL;
    op_a_float_var = NULL;
    op_a_char_var = NULL;
    switch (
