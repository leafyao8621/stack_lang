#ifndef CORE_CORE_RUN_HANDLERS_OPERATOR_HANDLERS_HANDLE_OPERATOR_BOR_ASSIGN_H_
#define CORE_CORE_RUN_HANDLERS_OPERATOR_HANDLERS_HANDLE_OPERATOR_BOR_ASSIGN_H_
...
extern inline SLErrCode runtime_handle_operator_bor_assign(SLInterpreter *interpreter);

inline SLErrCode runtime_handle_operator_bor_assign(SLInterpreter *interpreter) {
