#ifndef CORE_CORE_RUN_HANDLERS_COMMAND_HANDLERS_HANDLE_COMMAND_DO_FOR_H_
#define CORE_CORE_RUN_HANDLERS_COMMAND_HANDLERS_HANDLE_COMMAND_DO_FOR_H_
...
extern inline SLErrCode runtime_handle_command_do_for(SLInterpreter *interpreter);

inline SLErrCode runtime_handle_command_do_for(SLInterpreter *interpreter) {
