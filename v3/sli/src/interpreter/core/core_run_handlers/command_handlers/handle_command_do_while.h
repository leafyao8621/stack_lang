#ifndef CORE_CORE_RUN_HANDLERS_COMMAND_HANDLERS_HANDLE_COMMAND_DO_WHILE_H_
#define CORE_CORE_RUN_HANDLERS_COMMAND_HANDLERS_HANDLE_COMMAND_DO_WHILE_H_
...
extern inline SLErrCode runtime_handle_command_do_while(SLInterpreter *interpreter);

inline SLErrCode runtime_handle_command_do_while(SLInterpreter *interpreter) {
    int64_t op_int;
    double op_float;
    char op_char;
    Idx offset;
