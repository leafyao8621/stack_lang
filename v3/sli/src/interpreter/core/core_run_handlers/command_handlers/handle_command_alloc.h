#ifndef CORE_CORE_RUN_HANDLERS_COMMAND_HANDLERS_HANDLE_COMMAND_ALLOC_H_
#define CORE_CORE_RUN_HANDLERS_COMMAND_HANDLERS_HANDLE_COMMAND_ALLOC_H_
...
extern inline SLErrCode runtime_handle_command_alloc(SLInterpreter *interpreter);

inline SLErrCode runtime_handle_command_alloc(SLInterpreter *interpreter) {
    bool found = false;
    ...
    switch (
        interpreter
            ...
            .type) {
    case SL_TOKEN_TYPE_INT_VAR:
        *arr = (char*)calloc(nmemb, 8);
        break;
    case SL_TOKEN_TYPE_FLOAT_VAR:
        *arr = (char*)calloc(nmemb, 8);
        break;
    case SL_TOKEN_TYPE_CHAR_VAR:
        *arr = (char*)calloc(nmemb, 1);
        break;
